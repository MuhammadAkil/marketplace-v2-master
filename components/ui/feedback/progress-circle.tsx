...
function ProgressCircleRoot({ ref: forwardedRef, value = 0, max = 100, size, className, children, color = 'stroke-primary-base', ...rest }: ProgressCircleRootProps & { ref?: React.RefObject<SVGSVGElement | null> }) {
