...
import {
  IconEmptyCompany,
  IconEmptyUser,
} from '@/components/ui/data-display/avatar-empty-icons'
...
function AvatarRoot({
  ...
  ...rest
}: AvatarRootProps & { ref?: React.RefObject<HTMLDivElement | null> }) {
...
function AvatarImage({
  ...
  color,
  ...rest
}: AvatarImageProps & { ref?: React.RefObject<HTMLImageElement | null> }) {
...
function AvatarBrandLogo({
  ...
  className,
  ...rest
}: AvatarBrandLogoProps & { ref?: React.RefObject<HTMLImageElement | null> }) {
  const Component = asChild ? Slot : 'img'
