...
import * as Modal from '@/components/ui/overlay/modal'
...
function CommandInput({
  ...
  ref?: React.RefObject<React.ComponentRef<typeof Command.Input> | null>
}) {
  return (
    <Command.Input
      ref={forwardedRef}
...
function CommandList({
  ...
  ref?: React.RefObject<React.ComponentRef<typeof Command.List> | null>
}) {
  return (
    <Command.List
      ref={forwardedRef}
...
function CommandGroup({
  ...
  ref?: React.RefObject<React.ComponentRef<typeof Command.Group> | null>
}) {
  return (
    <Command.Group
      ref={forwardedRef}
...
function CommandItem({
  ...
  ref?: React.RefObject<React.ComponentRef<typeof Command.Item> | null>
}) {
  return (
    <Command.Item
      ref={forwardedRef}
